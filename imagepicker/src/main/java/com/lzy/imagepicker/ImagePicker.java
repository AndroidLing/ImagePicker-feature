...
public class ImagePicker {
    ...
    public static final String IMAGE_PICKER_VERSION = "1.1";
    ...
    private float cropInitialFrameScale = 0.7f;
    ...
    public float getCropInitialFrameScale() {
        return cropInitialFrameScale;
    }

    public void setCropInitialFrameScale(float cropInitialFrameScale) {
        this.cropInitialFrameScale = cropInitialFrameScale;
    }
