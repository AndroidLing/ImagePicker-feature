...
public class CircleProgress extends View implements CircleProgressAttrs {
    ...
    public CircleProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCircleWidth = typedArray.getDimension(R.styleable.CircleProgress_circleWidth, 5f);
        mColorSchemeColors[0] = typedArray.getColor(R.styleable.CircleProgress_circleColor, Color.WHITE);
        typedArray.recycle();
        init();
    }
